...
void loop() {
  ...
  if(ans == '1') {
    myFile = SD.open("FLOR.txt"); //Opening the file 
    ...
    myFile = SD.open("COHETE.txt"); //Opening the file 
    ...
    if(myFile) {
      Serial.println("\nEscriba los caracteres para crear su imagen, presione \"e\" para finalizar el documento");

    int i = 0;
    //e es el caracter scape. 
    while (ichar != 'e') {
